...
$e_address   = isset($_POST["e_address"]) ? addslashes(trim($_POST["e_address"])) : "";
$e_pin       = isset($_POST["e_pin"]) ? addslashes(trim($_POST["e_pin"])) : "";
$e_state     = isset($_POST["e_state"]) ? addslashes(trim($_POST["e_state"])) : "";
$e_city_town = isset($_POST["e_city_town"]) ? addslashes(trim($_POST["e_city_town"])) : "";
...
curl_close($lipl_ch);
		...
		$sql4 = "INSERT INTO $engineer_master
			(
				`e_name`,
				`e_email`,
				`te_code`,
