...
public class ImagePickerActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myActivity = ImagePickerActivity.this;
...
//        }
    ...
    private void chooseImageFromGallery() {
        ...
        myActivity.startActivityForResult(pickPhoto, REQUEST_GALLERY_IMAGE);
    }
...
//        options.setCircleDimmedLayer(true);
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.headerColor));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.statusBarColor));
//        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.headerColor));
