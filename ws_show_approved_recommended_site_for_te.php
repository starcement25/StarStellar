...
$approval_message = $row2["approval_message"] ? trim($row2["approval_message"]) : "";
...
$r_point_earned_by_engineer = $row2["r_point_earned_by_engineer"];
...
$actual_consumption = $row2["actual_consumption"] ? trim($row2["actual_consumption"]) : "0";
...
$approved_recommendation_data[] = array("r_site_id"=>$r_site_id,"r_site_name"=>$r_site_name,"r_te_code"=>$r_te_code,"r_recomended_by"=>$r_e_name,"r_contact_no"=>$r_e_mobile,"r_email"=>$r_e_email,"r_contact_person_name"=>$r_contact_person_name,"r_mobile_no"=>$r_mobile_no,"r_address"=>$r_address,"r_site_potential_in_mt"=>$r_site_potential_in_mt,"r_contact_person_category_name"=>$r_contact_person_category_name,"r_recomended_site_image_url"=>$r_recomended_site_image_url,"r_status"=>$r_status,"r_submission_date"=>$r_submission_date,"r_submission_date_modified"=>$r_submission_date_modified,"approved_date"=>$r_te_interaction_date,"stellar_points_earned"=>$r_point_earned_by_engineer,"comments"=>$r_te_interaction_comment,"expected_product_id"=>$r_expected_product_id,"expected_product_name"=>$r_expected_product_name,"expected_consumption"=>$r_expected_consumption,"actual_product_id"=>$actual_product_id,"actual_product_name"=>$actual_product_name,"actual_consumption"=>$actual_consumption,"purchased_from"=>$purchased_from,"purchased_from_name"=>$purchased_from_name,"purchased_from_area"=>$purchased_from_area,"purchased_from_contact_no"=>$purchased_from_contact_no,"approval_message"=>$approval_message);
}
