...
$pending_recommendation_data[] = array("r_site_id"=>$r_site_id,"r_site_name"=>$r_site_name,"r_te_code"=>$r_te_code,"r_recomended_by"=>$r_e_name,"r_contact_no"=>$r_e_mobile,"r_email"=>$r_e_email,"r_contact_person_name"=>$r_contact_person_name,"r_mobile_no"=>$r_mobile_no,"r_address"=>$r_address,"r_site_potential_in_mt"=>$r_site_potential_in_mt,"r_contact_person_category_name"=>$r_contact_person_category_name,"r_recomended_site_image_url"=>$r_recomended_site_image_url,"r_status"=>$r_status,"r_submission_date"=>$r_submission_date,"r_submission_date_modified"=>$r_submission_date_modified,"expected_product_id"=>$r_expected_product_id,"expected_product_name"=>$r_expected_product_name,"expected_consumption"=>$r_expected_consumption,"approval_message"=>$approval_message);
}
$res_data = array("process_status"=>"YES","process_message"=>"Success.","tot_count"=>$tot_res2cnt,"pending_recommendation_data"=>$pending_recommendation_data);
}else{
$res_data = array("process_status"=>"NO","process_message"=>"No new record found.","pending_recommendation_data"=>$pending_recommendation_data);
}
}else{
