...
$output .= '"Name","Mobile","Email","Point","Branch","Birthday","Anniversary","LINKED TE Code","LINKED TE Name","Address","Pin","State","City","App Access Status","Status By TE","Reg Datetime","Activity Status","Login Status","Device type","App Version","Image"';
...
$output .= '"'.$the_e_name.'","'.$the_e_mobile.'","'.$the_e_email.'","'.$the_e_points.'","'.$the_branch_code_selected.'","'.$the_e_dob.'","'.$the_e_dom.'","'.$the_te_code.'","'.$the_te_name.'","'.$the_e_address.'","'.$the_e_pin.'","'.$the_e_state.'","'.$the_e_city_town.'","'.$the_e_status.
