...
import forcepower.com.star_stellar.Activity.TE.TeProfileRecommendationDetails_A;
...
public class ApproveAdapter_Profile extends RecyclerView.Adapter { 
	...
	public ApproveAdapter_Profile(Activity myActivity_, List<Student> students, RecyclerView recyclerView) {
		...
		public StudentViewHolder(View itemView) {
			...
			itemView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent intent = new Intent(myActivity, TeProfileRecommendationDetails_A.class);
