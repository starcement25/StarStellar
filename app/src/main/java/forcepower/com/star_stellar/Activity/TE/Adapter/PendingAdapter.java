...
import forcepower.com.star_stellar.Activity.TE.TeRecommendationDetails_P;
...
public class PendingAdapter extends RecyclerView.Adapter {
    ...
    public PendingAdapter(Activity myActivity_, List<Student> students, RecyclerView recyclerView) {
        ...
        public StudentViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(myActivity, TeRecommendationDetails_P.class);
