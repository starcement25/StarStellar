...
import static forcepower.com.star_stellar.Class.AllUrl.tnc_weblink;
...
public class TermsConditionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            myActivity = TermsConditionActivity.this;
            //Header_View
            ...
            tvCaption.setText("Terms and Conditions");
            ...
            if (!tnc_weblink.matches("")) {
                //SHOW LOADING
                loadDialog();
                wv_termsNcondi.loadUrl(tnc_weblink);
            } else {
                tv_empty_View.setVisibility(View.VISIBLE);
            }
