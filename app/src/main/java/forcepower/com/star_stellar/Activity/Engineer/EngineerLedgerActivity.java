...
import forcepower.com.star_stellar.Activity.Engineer.Adapter.EngLedgerAdapter;
...
public class EngineerLedgerActivity extends BaseActivity {
    TextView tv_no_record, tv_points;
    ListView lv_Ledger;
    Activity myActivity;
    private ArrayList<CommonHelper> ledger_item_list = new ArrayList<>();
    public static String the_max_date_time_L = "";
    int page_no_L = 1;
    EngLedgerAdapter mAdapter;
    String total_epoint = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            myActivity = EngineerLedgerActivity.this;
            //Header_View
            ...
            the_max_date_time_L = "";
            mAdapter = new EngLedgerAdapter(myActivity, ledger_item_list);
        ...
        client.post(ws_show_my_ledger_for_engineer, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    print_Log_d("ledger_data_params172 ", params + "");

                    if (reader.optString("process_status").equalsIgnoreCase("YES")) {
                        if (page_no_L == 1) {
                            total_epoint = reader.optString("total_epoint");
                            tv_points.setText("Net Points : " + total_epoint);
                        }
                        page_no_L++;
                        ...
                        if (ja.length() > 0) {
                            ...
                            for (int i = 0; i < ja.length(); i++) {
                                ...
                                cdh.setItem5(e.getString("ldgr_type"));
                                cdh.setItem6(e.getString("related_data")); // related_data
