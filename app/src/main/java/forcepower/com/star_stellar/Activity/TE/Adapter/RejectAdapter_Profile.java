...
import forcepower.com.star_stellar.Activity.TE.TeProfileRecommendationDetails_R;
import forcepower.com.star_stellar.R;

import static forcepower.com.star_stellar.Class.CommonClass.print_Log_d;

public class RejectAdapter_Profile extends RecyclerView.Adapter {
    ...
    private OnLoadMoreListener_R onLoadMoreListener;
    public Activity myActivity;


    public RejectAdapter_Profile(Activity myActivity_, List<Student> students, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof StudentViewHolder) {
            ...
            ((StudentViewHolder) holder).tv_status_circle.setBackgroundResource(R.drawable.border_ring_orange);
    ...
    public void setOnLoadMoreListener(OnLoadMoreListener_R onLoadMoreListener) {
        ...
        public StudentViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    print_Log_d("recommended_site_r", " ");
                    Intent intent = new Intent(myActivity, TeProfileRecommendationDetails_R.class);
