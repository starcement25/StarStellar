...
public class TeHomeTopPicsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TeHomeTopPicsAdapter(ArrayList<CommonHelper> pending_list_, Activity myActivity) {
        ...
        viewHolder.iv_gift_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isInternetConnected(myActivity)) {
                    Intent intent = new Intent(myActivity, TeGiftsActivity.class);
