...
import forcepower.com.star_stellar.Activity.TE.TeRecommendationDetails_R;
import forcepower.com.star_stellar.R;

import static forcepower.com.star_stellar.Class.CommonClass.print_Log_d;

public class RejectAdapter extends RecyclerView.Adapter {
    ...
    public RejectAdapter(Activity myActivity_, List<Student> students, RecyclerView recyclerView) {
        ...
        public StudentViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(myActivity, TeRecommendationDetails_R.class);
