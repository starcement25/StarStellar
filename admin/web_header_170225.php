        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
					...
					<li <?php if($file_name=="te_master_update.php"){ echo 'class="active"';}?> style="display:none;">
                    ...
                    <li <?php if($file_name=="engineer_master_updated.php"){ echo 'class="active"';}?> style="display:none;">
