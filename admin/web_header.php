...
$sqlmenu = "select menu_id from $menu_master where `menu_admin_page`='$file_name'";
$resmenu = mysqli_query($conn,$sqlmenu);
$rowmenu = mysqli_fetch_assoc($resmenu);
$_SESSION["menu_id"]=$rowmenu["menu_id"];
if($file_name==''){
	$file_name = "index.php";
}
?>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
					...
					<li <?php if($file_name=="te_master_update.php"){ echo 'class="active"';}?>>
                        <a href="te_master_update.php">
                            <i class="material-icons">account_circle</i>
                            <span>TE Master</span>
                        </a>                        
                    </li>
                    <li <?php if($file_name=="add_edit_te_update.php"){ echo 'class="active"';}?> style="display:none;">
                        <a href="add_edit_te_update.php">
                            <i class="material-icons">view_list</i>
                            <span>Add/Edit TE</span>
                        </a>                        
                    </li>
                    ...
                    <li <?php if($file_name=="engineer_master_updated.php"){ echo 'class="active"';}?> >
                        <a href="engineer_master_updated.php">
                            <i class="material-icons">account_circle</i>
                            <span>Engineer Master</span>
                        </a>                        
                    </li>
                    ...
                    <li <?php if($file_name=="add_order_master.php"){ echo 'class="active"';}?>>
                        <a href="add_order_master.php">
                            <i class="material-icons">account_circle</i>
                            <span>Upload Order Status</span>
                        </a>                        
                    </li>
                    ...
                    <li <?php if($file_name=="add_points_for_engineer.php"){ echo 'class="active"';}?>>
                     ...
                     <li <?php if($file_name=="add_point_master.php"){ echo 'class="active"';}?>>
                        <a href="add_point_master.php">
                            <i class="material-icons">account_circle</i>
                            <span>Upload Points For Engineers</span>
                        </a>                        
                    </li>
                    <li <?php if($file_name=="category.php" || $file_name=="add_category.php" || $file_name=="update_category.php"){ echo 'class="active"';}?>>
                        <a href="category.php">
                    ...
                    <li <?php if($file_name=="gift_master.php" || $file_name=="add_gift_master.php"  || $file_name=="update_gift_master.php"){ echo 'class="active"';}?>>
                    ...
                    <!-- <li <?php if($file_name=="add_gift_master.php"){ echo 'class="active"';}?>>
                        <a href="gift_master.php">
                            <i class="material-icons">card_giftcard</i>
                            <span>Add Gift Master</span>
                        </a>                        
                    </li> -->
                    ...
                    <!-- <li <?php if($file_name=="home_screen_slider.php"){ echo 'class="active"';}?> style="display:none;">
                        <a href="home_screen_slider.php">
                            <i class="material-icons">view_list</i>
                            <span>Edit Home Screen Slider</span>
                        </a>                        
                    </li> -->
                   ...
                   <li <?php if($file_name=="add_edit_admin_user_master.php"){ echo 'class="active"';}?> style="display:none;">
                    ...
                    <li <?php if($file_name=="starstellar_app_setting_V2.php"){ echo 'class="active"';}?>>
                        <a href="starstellar_app_setting_V2.php">
                            <i class="material-icons">layers</i>
                            <span>App setting</span>
                        </a>                        
                    </li>
					 <li <?php if($file_name=="order_query_list.php"){ echo 'class="active"';}?>>
                        <a href="order_query_list.php">
                            <i class="material-icons">layers</i>
                            <span>Order Query</span>
                        </a>                        
                    </li>
                    <li <?php if($file_name=="redemption_points.php"){ echo 'class="active"';}?>>
                        <a href="redemption_points.php">
                            <i class="material-icons">reorder</i>
                            <span>Redemption points</span>
                        </a>                        
                    </li>
                     <li <?php if($file_name=="log_master.php"){ echo 'class="active"';}?>>
                        <a href="log_master.php">
                            <i class="material-icons">layers</i>
                            <span>Log Master Point</span>
                        </a>                        
                    </li>
                     <li <?php if($file_name=="gift_master_log.php"){ echo 'class="active"';}?>>
                        <a href="gift_master_log.php">
                            <i class="material-icons">layers</i>
                            <span>Gift Master Edit Log</span>
                        </a>                        
                    </li>
                     <li <?php if($file_name=="gift_status_log.php"){ echo 'class="active"';}?>>
                        <a href="gift_status_log.php">
                            <i class="material-icons">layers</i>
                            <span>Gift Master Status Log</span>
                        </a>                        
                    </li>
                    <li <?php if($file_name=="gift_order_log.php"){ echo 'class="active"';}?>>
                        <a href="gift_order_log.php">
                            <i class="material-icons">layers</i>
                            <span>Gift Order Master Log</span>
                        </a>                        
                    </li>
                     <li <?php if($file_name=="update_birthday_master.php"){ echo 'class="active"';}?>>
                        <a href="update_birthday_master.php">
                            <i class="material-icons">layers</i>
					...
					if($totres1>0){
						...
						$sqleditaccess =  "select menu_id from $selected_menu_for_user where  `user_id`='$the_admin_id' 
								AND edit_access='INACTIVE' order by `menu_id` asc";
						$reseditaccess = mysqli_query($conn,$sqleditaccess);
						while($roweditaccess=mysqli_fetch_assoc($reseditaccess)){
							array_push($ediit_inactive_menu_array,$roweditaccess['menu_id']);
						}
