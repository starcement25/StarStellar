...
if($whr_str!=""){
	$new_whr_str = " where  $ledger_master.`user_id` != '' AND  ".$whr_str;
}else{
	$new_whr_str ="where $ledger_master.`user_id` != '' ";
}
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
							...
							$res1 = mysqli_query($conn,$sql1);
							$totres1 = mysqli_num_rows($res1); ?>
                          <h2>Ledger Master (<?php if($total_pgres){ echo $total_pgres; }else{ echo $totres1; } ?>)&nbsp;&nbsp;&nbsp;<a href="export_ledger_master_all.php?paged=<?php echo $page.$export_filtered_str;?>" class="btn bg-red waves-effe">Export</a> 
...
if($gift_order_master_id !=''){
	$sql_ord="SELECT `order_id` FROM `gift_order_master` where `g_order_id`='".$gift_order_master_id."'";
...
<td style="width:200px;">
	<div style="width:200px;">
		...
		?>
		<?php echo '<span class="teEachField"><b>Order Id: </b>'.($gift_order_master_id!=''? $gift_order_master_id:$g_order_id).'</span>';?>
