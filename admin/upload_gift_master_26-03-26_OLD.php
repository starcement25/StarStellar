<?php
    ...
    if(($handle = fopen($destination, "r")) !== false) 
    {
        ...
        while(($data = fgetcsv($handle)) !== false) 
        {
            ...
            $stmt->bind_param("si", $gift_title, $gift_type_id); // s = string, i = int
            $stmt->execute();
            ...
            if($imgData !== false && $httpCode == 200) {
                ...
                if(file_put_contents($imgPath, $imgData)) {
                    ...
                    $stmt->bind_param("sisssss", $gift_title, $gift_type_id, $description, $localImagePath, $gift_point,  $cur_time, $admin_id); 
                    // s = string, i = int
