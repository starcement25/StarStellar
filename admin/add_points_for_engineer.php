...
?>
   ...
   <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12 add_top_bottom_padding">
    ...
    <!-- <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 add_top_bottom_padding">
	 ...
	 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 add_top_bottom_padding">
	<a href="add_point_master.php" class="btn bg-red waves-effe">Upload&nbsp;Point&nbsp;Master</a>
    </div>
...
jQuery(".point_deduct_button").click(function(){
	...
	if(the_eid!=""){
		...
		// 	return false;
		// }
		// sk 29-12-25 change condition to negative value available points
				if (deducted_points_num > current_points) {
			var confirmBox = confirm(
				"This action will result in a negative balance. Are you sure you want to continue?"
			);
