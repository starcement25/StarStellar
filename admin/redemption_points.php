        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
<h2>Redemption Points (<?php echo $total_pgres;?>)&nbsp;&nbsp;&nbsp;<a href="export_order_master.php?paged=<?php echo $page.$export_filtered_str;?>" class="btn bg-red waves-effe">Export</a> &nbsp;&nbsp;<span class="rpt_loader"></span> <span class="shomsg"><?php if($msg_txt!=""){ echo $msg_txt;}?></span>
...
<span class="adminActivityField">
	<?php 
	/*if($r_status=='REJECT' || $r_status=='COMPLAINT/FEEDBACK'){
...
jQuery(".admin_update_order_data").click(function(){
	...
	if(the_ord_id!=""){
		...
		jQuery.ajax({
				...
				type: 'post',
				dataType: 'json',
				data: "the_ord_id="+the_ord_id+"&admin_sl_ord_sts="+admin_sl_ord_sts+"&admin_del_dt="+admin_del_dt+"&admin_amz_ord_id="+admin_amz_ord_id+"&admin_old_status="+admin_old_status+"&admin_amz_ord_link="+admin_amz_ord_link,
