...
if($the_eid!=''){
	if($added_point==''){
		...
		if($totres1>0){
			...
			$sqlin = "insert into $ledger_master (`user_id`,`ldgr_type`,`description`,`point_earned`,`ldgr_datetime`,`remaining_balance`) values ('$the_eid','ADDED_BY_ADMIN','$added_description','$added_point','$curr_datetime','$calculated_point')";
			...
			mysqli_query($conn,"
				...
				VALUES
				('$the_eid','$action','$present_point','$added_point','$calculated_point','$admin_id','$now')
			");
