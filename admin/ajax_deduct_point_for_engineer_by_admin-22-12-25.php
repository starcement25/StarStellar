...
if($the_eid!=''){
	if($added_point==''){
		...
		if($totres1>0){
			...
			$sqlin = "insert into $ledger_master (`user_id`,`ldgr_type`,`description`,`point_redeem`,`ldgr_datetime`) values ('$the_eid','DEDUCTED_BY_ADMIN','$added_description','$added_point','$curr_datetime')";
