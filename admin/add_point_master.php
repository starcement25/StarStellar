    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        <h2>Upload Points For Engineers CSV</h2>
                    </div>
                    <div class="body" style="padding:20px;">
                        <form action="upload_point_master.php" method="post" enctype="multipart/form-data" id="bulk_gift_master_add" class="send_notification_form">
                            ...
                            <a href="csv_formats/Dummy_points_for_engineers.csv" download="upload_points_for_engineers">Download Format</a>
                        </form>
