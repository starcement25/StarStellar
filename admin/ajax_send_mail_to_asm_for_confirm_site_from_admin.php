...
$upd_qry = "";
if($r_actual_product_id==""){
$r_actual_product_id = $r_expected_product_id;
$r_actual_product_name = $r_expected_product_name;
$r_actual_consumption = $r_expected_consumption;
$upd_qry = ",`actual_product_id`='$r_actual_product_id',`actual_product_name`='$r_actual_product_name',`actual_consumption`='$r_actual_consumption'";	
}
...
$sql4 = "update $recommended_site_master set `is_mail_sent_to_asm`='YES',`approval_message`='ASM FOR APPROVAL',`r_asm_id`='$en_asm_id',`r_asm_name`='$en_asm_name',`r_asm_email`='$en_asm_email',`r_asm_ph_no`='$en_asm_ph_no',`r_asm_branch`='$en_branch_name'".$upd_qry." where `r_site_id`='$r_site_id' and `r_te_code`='$te_code'";
