...
$output .= '"Engineer Name","Engineer Phn No","Branch","TE CODE","TE Name","TE Mobile","Order No","Old Order No","Description","Point Earned","Product Point","TDS","Point Redeem","Remaining Balance","Creation Date"';
...
$old_order_id='';
 if($r_point_redeem!=""){
			$sqlgift_id="SELECT GOM.order_id,tds,GOM.g_order_id FROM `gift_master` GF,gift_order_master GOM WHERE GOM.gift_id=GF.id and GF.`gift_title`='".$r_description."' AND GOM.user_id='".$r_engineer_id."'";
...
$output .= '"'.$r_engineer_name.'","'.$r_engineer_mobile.'","'.$the_branch_code_selected.'","'.$r_te_code.'","'.$r_te_name.'","'.$r_te_mobile_no.'","'.$g_order_id.'","'.$old_order_id.'","'.$r_description.'","'.$r_point_earned.'","'.$product_point.'","'.$tds.'","'.$r_point_redeem.'","'.$remaining_balance.'","'.$ldgr_datetime.'"';
$output .="\n";
}
