...
if($the_ord_id!=''){
	 $sql5 = "update $gift_order_master set `status`='$admin_sl_ord_sts',`delivery_date`='$admin_del_dt',`amazon_order_id`='$admin_amz_ord_id',`amazon_order_link`='$admin_amz_ord_link',`remarks`='$admin_remarks' where `g_order_id`='$the_ord_id'";
