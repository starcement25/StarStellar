...
$order_status_arr = array("PENDING","ORDER PLACED","DELIVERED","REJECT");
...
<?php if($the_g_order_id!=""){echo '<span class="engineerEachField"><b>Order ID:</b> '.$the_g_order_id.'</span>';}?>
...
<option value="<?php echo $order_status_arr_val2;?>" <?php if($order_status_arr_val2==$r_status){?> selected="selected" <?php } ?>><?php echo $order_status_arr_val2;?></option>
	<?php }
}
?>
</select>
...
<span class="adminActivityField">
<input type="text" class="form-control" id="admin_amz_ord_id_<?php echo $the_g_order_id;?>" value="<?php echo $r_amazon_order_id;?>" placeholder="Order Id">
</span>
<span class="adminActivityField">
<input type="text" class="form-control" id="admin_amz_ord_link_<?php echo $the_g_order_id;?>" value="<?php echo $r_amazon_order_link;?>" placeholder="Order Link">
</span>
<span class="adminActivityField">
...
jQuery(".admin_update_order_data").click(function(){
	...
	if(the_ord_id!=""){
		...
		jQuery.ajax({
				...
				type: 'post',
				dataType: 'json',
				data: "the_ord_id="+the_ord_id+"&admin_sl_ord_sts="+admin_sl_ord_sts+"&admin_del_dt="+admin_del_dt+"&admin_amz_ord_id="+admin_amz_ord_id+"&admin_amz_ord_link="+admin_amz_ord_link,
