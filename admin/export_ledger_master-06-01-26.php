...
$output .= '"Engineer Name","Engineer Phn No","Branch","TE CODE","TE Name","TE Mobile","Order No","Gift ID","Description","Shipping Address","Shipping Pin","Point Earned","Product Point","TDS","Point Redeem","Remaining Balance","Creation Date"';
...
$output .= '"'.$r_engineer_name.'","'.$r_engineer_mobile.'","'.$the_branch_code_selected.'","'.$r_te_code.'","'.$r_te_name.'","'.$r_te_mobile_no.'","'.$g_order_id.'","'.$gift_id.'","'.$r_description.'","'.$address.'","'.$pin.'","'.$r_point_earned.'","'.$product_point.'","'.$tds.'","'.$r_point_redeem.'","'.$remaining_balance.'","'.$ldgr_datetime.'"';
$output .="\n";
}
