...
<td style="text-align:center;"><a href="engineer_master.php?srch_eng_dtls=<?php echo $the_te_code;?>&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_linked_engineer;?></a></td>
...
<td style="text-align:center;"><a href="engineer_master.php?srch_eng_dtls=<?php echo $the_te_code;?>&sl_activity_status=ACTIVE&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_active_engineer;?></a></td>
<td style="text-align:center;"><a href="engineer_master.php?srch_eng_dtls=<?php echo $the_te_code;?>&sl_activity_status=INACTIVE&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_inactive_engineer;?></a></td>
</tr>
