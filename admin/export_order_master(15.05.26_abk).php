<?php
	...
	function startCreatOrderMasterCsvfile($conn,$trn_te_code,$sl_en_id,$srch_eng_te_site_dtls,$sl_ord_sts,$sl_day_wise,$from_dt,$to_dt)
	{
		...
		$output .= '"Order Id","Old Order Id","Amazon Order Id","Amazon Order Link","Item","Ordered On","Order Received","Product Point","TDS","Point Reedem","Delivery Date","Status","Engineer Name","Engineer Phn No","Engineer Email","City","Pin","State","Address","TE Code","TE Name","TE Branch Code","TE Branch Name"';
