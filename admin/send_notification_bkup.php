...
$sql4 = "select `te_code`,`te_name` from $te_master order by `te_name` asc";
$res4 = mysql_query($sql4);
$totres4 = mysql_num_rows($res4);

$sql6 = "select `eid`,`e_name`,`e_mobile` from $engineer_master order by `e_name` asc";
$res6 = mysql_query($sql6);
$totres6 = mysql_num_rows($res6);
