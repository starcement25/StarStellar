<?php
	...
	function startCreatOrderMasterCsvfile($conn,$trn_te_code,$sl_en_id,$srch_eng_te_site_dtls,$sl_ord_sts,$sl_day_wise,$from_dt,$to_dt)
	{
		...
		$output .= '"Order Id","Amazon Order Id","Amazon Order Link","Item","Ordered On","Order Received","Point Reedem","Delivery Date","Status","Engineer Name","Engineer Phn No","Engineer Email","City","Pin","State","Address","TE Code","TE Name","TE Branch Code","TE Branch Name"';
		...
		while ($row1 = mysqli_fetch_assoc($sql)) 
		{
			...
			$output .= '"'.$the_g_order_id.'","'.$r_amazon_order_id.'","'.$r_amazon_order_link.'","'.$r_gift_title.'","'.$r_datetime.'","'.$is_order_received.'","'.$r_point_taken.'","'.$r_delivery_date.'","'.$r_status.'","'.$r_engineer_name.'","'.$r_engineer_mobile.'","'.$r_engineer_email.'","'.$r_city.'","'.$r_pin.'","'.$r_state.'","'.$r_address.'","'.$r_te_code.'","'.$r_te_name.'","'.$r_te_branch_code.'","'.$r_te_branch_name.'"';
			$output .="\n";
		}
