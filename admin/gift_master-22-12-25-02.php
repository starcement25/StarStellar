			...
			if($add_gft_img_file_name!="")
			{
				...
				else
				{
					...
					if($upload_the_ad_file)
					{
						...
						$sqlsldupd = "update $gift_master set `gift_title`='$add_gft_title',`description`='$add_gft_des',`gift_type_id`='$add_gift_type',`point_require`='$add_gft_point',`gift_image`='$ad_new_name' where `id`='$gft_hid_id'";
					...
					{
						$sqlsldupd = "update $gift_master set `gift_title`='$add_gft_title',`description`='$add_gft_des',`gift_type_id`='$add_gift_type',`point_require`='$add_gft_point' where `id`='$gft_hid_id'";
						$ressldupd = mysqli_query($conn,$sqlsldupd);
	...
	if(@$_POST["add_gft_btn"]=="Save")
	{
		...
		else
		{
			...
			else
			{
				...
				if($upload_the_ad_file)
				{
					$sqlsldin = "insert into $gift_master (`gift_title`,`description`,`gift_image`,`point_require`, `gift_type_id`) values('$add_gft_title','$add_gft_des','$ad_new_name','$add_gft_point','$add_gift_type')";
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
							Gift Master (<?php echo $total_pgres;?>)&nbsp;&nbsp; <a href="export_gift_master.php" class="btn bg-red waves-effe">Export&nbsp;Gift&nbsp;Master</a> &nbsp; &nbsp;<span class="shomsg"><?php if($msg_txt!=""){ echo $msg_txt;}?></span>
                        </h2>
                    	<div class="row clearfix">
