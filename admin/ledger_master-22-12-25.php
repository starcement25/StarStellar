                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
							...
							$res1 = mysqli_query($conn,$sql1);
							$totres1 = mysqli_num_rows($res1); ?>
                          <h2>Ledger Master (<?php if($total_pgres){ echo $total_pgres; }else{ echo $totres1; } ?>)&nbsp;&nbsp;&nbsp;<a href="export_ledger_master.php" class="btn bg-red waves-effe">Export</a> &nbsp;&nbsp;<span class="rpt_loader"></span> <span class="shomsg"><?php if($msg_txt!=""){ echo $msg_txt;}?></span>
...
<td style="width:200px;">
	<div style="width:200px;">
		<?php if($r_point_redeem!=""){
			$sqlgift_id="SELECT GOM.g_order_id FROM `gift_master` GF,gift_order_master GOM WHERE GOM.gift_id=GF.id and GF.`gift_title`='".$r_description."' AND GOM.user_id='".$r_engineer_id."'";
			
			$resgift_id = mysqli_query($conn,$sqlgift_id);
			$rowgift_id=mysqli_fetch_assoc($resgift_id);
			$g_order_id = $rowgift_id["g_order_id"];
