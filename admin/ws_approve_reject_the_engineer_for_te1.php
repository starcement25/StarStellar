...
if($te_code!="" && $eid!="" && $status!=""){
    ...
    $sql_branch_code = "SELECT branch_code FROM $te_master WHERE te_code = '$te_code'";
    $res_branch_code = mysqli_query($conn, $sql_branch_code);
    if (!$res_branch_code) {
        $error_message = mysqli_error($conn);
        $res_data = array("process_status" => "NO", "process_message" => "Error fetching branch_code: $error_message");
