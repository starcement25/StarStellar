...
$output .= '"TE CODE","Order No","Gift ID","Description","Gift Point","Engineer Name","Engineer Phn No","Branch","TE Name","TE Mobile","Shipping Address","Shipping Pin","Point Added","Point Reduced","TDS","Available Points","Creation Date"';
...
$output .= '"'.$r_te_code.'","'.$g_order_id.'","'.$gift_id.'","'.$r_description.'","'.$product_point.'","'.$r_engineer_name.'","'.$r_engineer_mobile.'","'.$the_branch_code_selected.'","'.$r_te_name.'","'.$r_te_mobile_no.'","'.$address.'","'.$pin.'","'.$r_point_earned.'","'.$r_point_redeem.'","'.$tds.'","'.$remaining_balance.'","'.$ldgr_datetime.'"';
$output .="\n";
}
