...
function sentNotificationToAll($pno,$the_title,$the_message,$user_type,$selected_branch_user_id,$the_m_image_link,$noty_id,$total_sending_count){
$notification_message = "notification_message";
$te_master = "te_master";
...
$new_pno = ($pno+1);
sentNotificationToAll($new_pno,$the_title,$the_message,$user_type,$selected_branch_user_id,$the_m_image_link,$noty_id,$total_sending_count);	
}else{
	if($noty_id!=''){
...
if($totres1>0){
	...
	$user_type = $row1["user_type"] ? strtoupper(trim($row1["user_type"])) : "ALL";
	...
	sentNotificationToAll(1,$title,$message,$user_type,$selected_branch_user_id,$m_image_link,$noty_id_decrspt,0);
}
