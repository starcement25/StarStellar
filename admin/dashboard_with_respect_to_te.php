...
$whr_str = "";
$export_filtered_str = "";
$search_array = array("srch_eng_te_site_dtls"=>$srch_eng_te_site_dtls,"trn_zone"=>$trn_zone,"trn_branch"=>$trn_branch,"data_show_type"=>$data_show_type,"daywise"=>array("sl_day_wise"=>$sl_day_wise,"from_dt"=>$from_dt,"to_dt"=>$to_dt));
...
$sqlzonecode = "select DISTINCT zone from $branch_master order by zone asc ";
$reszonecode = mysqli_query($conn,$sqlzonecode);
$tot_zonecode = mysqli_num_rows($reszonecode);

$sqlbranchcode = "select branch_code,branch_name from $branch_master order by branch_name asc ";
$resbranchcode = mysqli_query($conn,$sqlbranchcode);
$tot_branchcode = mysqli_num_rows($resbranchcode);
$cnt = 0;
$countrow = 1;
...
$pgsql = "select `te_id` from $te_master where `acedns`='Y' $new_whr_str ";
...
&nbsp;&nbsp;<a href="export_dashboard_with_respect_to_te_data.php?srch_eng_te_site_dtls=<?php echo $srch_eng_te_site_dtls;?>&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>&trn_zone=<?php echo $trn_zone;?>&trn_branch=<?php echo $trn_branch;?>" class="btn bg-red waves-effe">Export&nbsp;TE&nbsp;Dashboard&nbsp;Data</a>
...
<input type="text" class="form-control" id="srch_eng_te_site_dtls" value="<?php echo $srch_eng_te_site_dtls;?>" placeholder="Search By TE Details">
    ...
    <select name="trn_zone" id="trn_zone" class="form-control">
    <option value="">Select Zone</option>
    <?php
    if($tot_zonecode>0){
        while($rowzonecode=mysqli_fetch_assoc($reszonecode)){
            $zone_code = $rowzonecode["zone"];
    ?>
    <option value="<?php echo $zone_code;?>" <?php if($trn_zone == $zone_code){?> selected="selected" <?php } ?> ><?php echo $zone_code;?></option>
    <?php
        }
    }
    ?>
...
<?php
if($tot_branchcode>0){
	while($rowbranchcode=mysqli_fetch_assoc($resbranchcode)){
		$branch_code_te = $rowbranchcode["branch_code"];
		$branch_name_te = $rowbranchcode["branch_name"];
?>
<option value="<?php echo $branch_code_te;?>" <?php if($trn_branch == $branch_code_te){?> selected="selected" <?php } ?> ><?php echo $branch_name_te;?></option>
<?php
	}
}
?>
...
<th scope="col">GIFT</BR>PENDING</th>
...
<tbody>
<?php
$sql1 = "select * from $te_master where `acedns`='Y' $new_whr_str order by `zone` asc limit $start_from,$limit";
$res1 = mysqli_query($conn,$sql1);
$totres1 = mysqli_num_rows($res1);
if($totres1>0){
	while($row1=mysqli_fetch_assoc($res1)){
...
$gift_pending = $gift_redemed-$gift_delevered;
...
<td style="text-align:center;"><a href="engineer_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_linked_engineer;?></a></td>
<td style="text-align:center;"><a href="recomended_site_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_site_recomended;?></a></td>
<td style="text-align:center;"><a href="recomended_site_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_ord_sts=APPROVED&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_site_approved;?></a></td>
<td style="text-align:center;"><a href="recomended_site_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_ord_sts=PENDING&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_site_pending;?></a></td>
<td style="text-align:center;"><a href="recomended_site_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_ord_sts=REJECTED&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_site_rejected;?></a></td>
<td style="text-align:center;"><a href="order_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $gift_redemed;?></a></td>
<td style="text-align:center;"><a href="order_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_ord_sts=DELIVERED&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $gift_delevered;?></a></td>
<td style="text-align:center;"><a href="order_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_ord_sts=PENDING&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $gift_pending;?></a></td>
<td style="text-align:center;"><a href="support_master.php?srch_eng_dtls=<?php echo $the_te_code;?>&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $query_raised;?></a></td>
<td style="text-align:center;"><a href="support_master.php?srch_eng_dtls=<?php echo $the_te_code;?>&sl_supp_status=RESOLVE&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $query_solved;?></a></td>
<td style="text-align:center;"><a href="engineer_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_activity_status=ACTIVE&sl_status_by_te=APPROVED&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_active_engineer;?></a></td>
<td style="text-align:center;"><a href="engineer_master.php?trn_te_code=<?php echo $the_te_code;?>&sl_activity_status=INACTIVE&sl_status_by_te=APPROVED&sl_day_wise=<?php echo $sl_day_wise;?>&from_dt=<?php echo $from_dt;?>&to_dt=<?php echo $to_dt;?>" target="_blank"><?php echo $total_inactive_engineer;?></a></td>
</tr>
...
jQuery(".srch_btn").click(function(){
		...
		var trn_zone = jQuery("#trn_zone").val();
		var trn_branch = jQuery("#trn_branch").val();
		...
		var dtstring ="";
		var amp = "";
		if(sl_day_wise!="" || srch_eng_te_site_dtls!=""  || trn_zone!="" || trn_branch!=""){
		...
		if(trn_zone!=""){
		if(qstring==""){
		qstring = qstring+"trn_zone="+trn_zone;
		}else{
		qstring = qstring+"&trn_zone="+trn_zone;  
		}
		}
		if(trn_branch!=""){
		if(qstring==""){
		qstring = qstring+"trn_branch="+trn_branch;
		}else{
		qstring = qstring+"&trn_branch="+trn_branch;  
		}
		}
