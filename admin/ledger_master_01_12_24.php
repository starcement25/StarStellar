        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>Ledger Master (<?php echo $total_pgres;?>)&nbsp;&nbsp;&nbsp;<a href="export_ledger_master.php" class="btn bg-red waves-effe">Export</a> &nbsp;&nbsp;<span class="rpt_loader"></span> <span class="shomsg"><?php if($msg_txt!=""){ echo $msg_txt;}?></span>
...
if($ldgr_datetime!=""){
	$ldgr_datetime = date("dS M, Y",strtotime($ldgr_datetime));
}
?>
<?php
